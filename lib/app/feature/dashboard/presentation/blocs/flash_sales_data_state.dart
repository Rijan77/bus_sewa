...
class FlashSaleDataState extends Equatable {
  ...
  const FlashSaleDataState({this.status = ApiStatus.initial, this.flashSales= const[], this.error});


  FlashSaleDataState copyWith ({ApiStatus? status, List<FlashSaleModel>? flashSales, String? error}){
